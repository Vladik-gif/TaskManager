...
public class TaskController {
    ...
    private static final String FILTER_STATUS = "/filter/status/{status}";
    private static final String FILTER_CATEGORY = "/filter/category/{category}";
    ...
    public TaskDto update(@PathVariable Long id,
                          @Valid @RequestBody TaskEntity todo){
        return taskService.updateByIdTodo(id, todo);
    }
    ...
    public List<TaskDto> filterCategory(@PathVariable String category){
        return taskService.filterCategory(category);
    }
